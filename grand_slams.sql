...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2654766003ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grand_slams&table=titles">`grand_slams`.`titles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grand_slams&table=champions">`grand_slams`.`champions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grand_slams&table=access">`grand_slams`.`access`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grand_slams&table=users">`grand_slams`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=student_alcohol_consumption&table=student_mat">`student_alcohol_consumption`.`student_mat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__history">`phpmyadmin`.`pma__history`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bi_database&table=video">`bi_database`.`video`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bi_database&table=movie">`bi_database`.`movie`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mysql&table=event">`mysql`.`event`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mysql&table=column_stats">`mysql`.`column_stats`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6d6a62432875255822355636292f456e">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="214"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="grand_slams" targettable="champions">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `champions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="champions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `champions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="access">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `access`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="champions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `champions`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="titles">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `titles`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="champions">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `titles`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="grand_slams" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
